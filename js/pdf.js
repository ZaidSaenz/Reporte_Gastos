...
// ============================================================
// ESCRIBIR CANTIDAD POR TIPO DE CANJE
// ============================================================
//
// Los nombres de los canjes ya están impresos en el PDF.
// Aquí solo escribimos la cantidad junto al renglón
// correspondiente.
//
// ============================================================

function dibujarDetalleCanjes(
  pagina,
  fuenteNegrita
) {
  const canjes =
    typeof obtenerResumenCanjesPdf ===
    "function"
      ? obtenerResumenCanjesPdf()
      : [];

  const yPrimeraFilaCanje =
    592;
